<template>
    <div class="HomePage">
                ...
                <div class="d-flex justify-space-between align-center mt-3 mb-3">
                    ...
                    <div class="Search">
                        <v-text-field :loading="loading" append-inner-icon="mdi-magnify" density="compact"
                            label="Search books" variant="solo" hide-details single-line rounded="pill"
                            @click:append-inner="onClick"></v-text-field>
                    </div>
                    <div>
                        <v-btn color="primary" @click="onClick" variant="outlined" rounded="pill" class="mr-4">Log
                            In</v-btn>
                        <v-btn color="primary" rounded="pill" @click="onClick">Sign Up</v-btn>
                    </div>
                </div>
            </v-container>
        </div>
        ...
        <v-container>
            ...
            <v-row>
                <v-col lg="2" md="4" sm="4" v-for="category in categories" :key="category.title">
                    <div class="relative d-flex align-center flex-column">
                        ...
                        <div class="mb-5 d-flex justify-center align-center flex-column">
                            ...
                            <p class="text-subtitle-2 font-weight-bold">{{ category.title }}</p>
                        </div>
                    </div>
                </v-col>
            </v-row>
            ...
            <v-container>
                <v-row>
                    <v-col lg="8" md="12" sm="12" >
                        ...
                        <v-row>
                            <v-col cols="12" class="d-flex justify-space-between">
                                <span>
                                    @CopyRight 2021 Bookie. All Rights Reserved
                                </span>
                                <span>
                                    Site by Nguyen Hong Duyen
                                </span>
                            </v-col>
                        </v-row>
                        </div>
                    ...
                    <v-col lg="4" md="12" sm="12">
                        <div class="FooterItem">
                            <h1 class="text-capitalize text-white mb-5">subscribe to our newsletter!</h1>
                            <div class="d-flex">
                                <v-text-field label="Email Address" variant="outlined" rounded="lg" class="mr-2"></v-text-field>
...
.FeatureItem {
    ...
    background: linear-gradient(0deg, rgba(255, 255, 255, 1) 17%, rgba(162, 135, 215, 0.5333333333333333) 100%);
